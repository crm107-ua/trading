...
VARIANTS: list[tuple[str, dict[str, Any]]] = [
    ...
    (
        "pulse_flow",
        {
            ...
            "max_quote_mid": 0.70,
            "quote_time_min_s": 90,
            "quote_time_max_s": 280,
            "pulse_persist_polls": 1,
            "min_bid_imbalance": 0.42,
            "min_expected_pnl_usdc": 0.03,
            "max_mid_catchup": 0.06,
            "min_market_spread": 0.005,
        },
    ),
    (
        "pulse_mid_open",
