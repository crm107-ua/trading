...
DNA: list[tuple[str, str, str, dict[str, Any]]] = [
    ...
    (
        "follow_tight",
        "maker_follow",
        "maker_demo_follow_gate.json",
        {
            "follow_up_lo": 0.55,
            "follow_up_hi": 0.70,
            "follow_min_roll_usd": 1.5,
            "lock_profit_usdc": 0.06,
            "max_loss_usdc": 0.06,
        },
    ),
    ("pulse_flow", "maker_pulse", "maker_demo_pulse_gate.json", {
        "min_spot_lead_usd": 1.5,
        "min_spot_velocity_usd": 0.4,
        "min_edge": 0.012,
        "pulse_persist_polls": 1,
        "quote_time_min_s": 70,
    }),
    ("selective_v2", "maker_edge", "maker_demo_grind_nim_best.json", {
