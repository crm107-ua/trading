...
python3 -m polymarket.research.local_lab.sim_micro_compound \
  --start 2.0 --rounds 10 --minutes 6
```

## Real (solo tras MICRO2_CERTIFIED)
```bash
export POLY_LIVE_ARMED=1 POLY_LIVE_DRY_RUN=1 POLY_LIVE_MAX_CAPITAL_USDC=2
# dry 30–45m…
